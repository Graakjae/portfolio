...
export default function AboutText() {
    ...
    return (
        <section className="relative bg-black rounded-t-[20px] pt-10 px-[5%]" id="ABOUT ME">
            <h2 className="text-[#D1D1C8] font-extrabold text-[56px] md:text-[86px] my-10 leading-[0.5] ">ABOUT ME</h2>
            <div className="md:flex md:justify-between">
                <div className="w-[100%] md:w-[47%] bg-[#212121] rounded-lg flex justify-center items-center mb-[30px] md:mb-0">
                    <p className="text-[#D1D1C8] font-regular text-[22px] w-[90%] py-5 px-1">
                        My name is Frederik Graakjær and I'm a web developer student based in Aarhus. I specialize in
                        building responsive and user-friendly websites. I have expertise in various JavaScript
                        technologies commonly used for frontend and fullstack development.
                    </p>
                </div>
